...
nomes_csvs <- list.files(path = '.', pattern = glob2rx('sim_mc*.csv'))
...
# for (aux_df_sim in c(1:6, 10:17)) {
#    df_sim[, aux_df_sim] <- as.numeric(paste(df_sim[, aux_df_sim]))
# }
...
write.xlsx(df_sim, 'mc_aglomerados.xlsx')
